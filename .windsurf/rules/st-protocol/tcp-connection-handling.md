---
trigger: glob
description: TCP connection and socket management rules for ST protocol (port 8003)
---

# ST Protocol TCP Connection Handling
...
- **Protocol Version**: Use version 2 for responses
- **Endianness**: Little endian for all numeric fields
- **Frame Length**: 20 + payloadSize (header 14 + payload + CRC 2 + tail 4)
- **CRC**: 2-byte CRC16 IBM ARC
