...
export default function ObjVarIndividualNavegacion({ obj, onNavegar }: ObjVarIndividualNavegacionProps): JSX.Element | null {
  ...
  return (
    <div
      className="col-span-6 flex justify-between items-center px-4 py-2 border-b border-zinc-100 cursor-pointer hover:bg-zinc-50 active:bg-zinc-100 transition-colors"
      onClick={() => navegarConEdicion(nav, obj.indicePantalla as number, onNavegar)}
    >
