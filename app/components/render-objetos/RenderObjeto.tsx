...
export default function RenderObjeto({ obj, onNavegar, idPantallaActual, esLista }: RenderObjetoProps) {
  switch (obj.tipoObjeto) {
    ...
    case 4:
      return <ObjLineaTextVar obj={obj} onNavegar={onNavegar} />

    // objLineaTextText — fila con texto principal + textoVar en naranja + flecha
    case 16:
      return <ObjLineaTextText obj={obj} onNavegar={onNavegar} />

    // objLineaText — lista de filas (tipoPlantilla 4) o grid de iconos (menú)
    case 5:
      return <ObjLineaText obj={obj} onNavegar={onNavegar} esLista={esLista} />
    ...
    case 37:
      return <ObjVarIndividualNavegacion obj={obj} onNavegar={onNavegar} />
