...
export interface ParametrosSeleccionCti40Plus {
  params: URLSearchParams[];
  errorMessage: string;
  navegarSinPeticiones?: boolean;
}
export function buildParametrosSeleccionCti40Plus(args: BuildSeleccionParamsArgs): ParametrosSeleccionCti40Plus | null {
