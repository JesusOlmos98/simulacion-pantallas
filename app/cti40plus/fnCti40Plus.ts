...
export { buildParametrosSeleccionCti40Plus } from './fnCti40PlusSeleccion';
export type { ParametrosSeleccionCti40Plus } from './fnCti40PlusSeleccion';
export const DEFAULT_MAC_CTI40PLUS = '202000029'; // MAC por defecto para entradas antiguas a /cti40plus
...
export interface DerivadosCti40Plus {
...
export async function responseToObjetos(res: Response): Promise<ObjBase[]> {
...
export function getBotonesAccesoDirecto(data: ObjBase[]): ObjBase[] {
  return data.filter((o) => o.tipoObjeto === 66);
}
...
export function buildTextoConcatenadoMap(objetos: ObjBase[] | null, lang?: string): Map<number, string> {
...
export function buildDerivadosCti40Plus(objetos: ObjBase[] | null, actual: DescriptorPantalla, textoConcatenadoMap: Map<number, string>, lang?: string): DerivadosCti40Plus {
